...
/** 하단 네비에 표시할 메뉴 6개 (홈~기록, 대화요약 제외) */
const bottomItems = menuItems.slice(0, 6);
      ...
      <div className="flex items-center h-12">
        ...
        {pomodoroTask && pomodoroTimeStr && (
          <button
            ...
            className={`flex items-center gap-1.5 px-2 py-1 rounded-xl mr-1 flex-shrink-0 transition-colors ${
        ...
        <div className="flex items-center justify-around flex-1">
          {bottomItems.map((item) => (
            <NavLink
              ...
              to={item.path}
              className={({ isActive }) =>
                `flex flex-col items-center gap-0.5 px-1.5 py-1 rounded-xl transition-colors ${
