  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      <button
        ...
        className="w-full flex items-center gap-2 px-4 py-3 bg-gray-50 border border-gray-200 text-sm text-left focus:outline-none focus:ring-1 focus:ring-purple-200"
      >
        {selected ? (
          <>
