...
import {
  ...
  InsightsView, LogView, ActivityView, ActivityFeedView, MembersView, ProductsView, ContentItemsView, SalesDailyView, CompanyMemoryView, TaskDetailView, InsightDetailView, RecordDetailPage,
} from './views';
...
export function OfficeShell({ workspace }: { workspace: Workspace }) {
  ...
  return (
    <div className="office-shell h-[100dvh] overflow-hidden flex flex-col bg-[#eef3ef] text-gray-800">
      {/* 상단바 */}
      ...
      <main className="flex-1 overflow-y-auto px-5 sm:px-10 py-8 sm:py-12 pb-[calc(5rem+env(safe-area-inset-bottom))] lg:pb-12">
        <div className="max-w-5xl mx-auto">
          ...
          {view === 'log' && (detailId
            ...
            : <LogView workspace={workspace} onNavigate={onNavigate} />)}
