...
function InsightRow({
  ...
  const stripped = stripMarkdown(item.content);
  const preview = stripped.slice(0, previewLength);
  const hasMore = stripped.length > previewLength;
